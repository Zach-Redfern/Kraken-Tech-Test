import { filterOutagesBefore2022, filterSiteOutages } from "../src";
...
describe('testing index file', () => {
  test('Remove pre 2022 outages from data', () => {
    ...
    expect(filterOutagesBefore2022(outagesTestData)).toStrictEqual(outagesTestExpectedOutcome)
  })
  test('Return only outages that happended at a given site with the device name included', () => {
    ...
    expect(filterSiteOutages(outagesTestData, siteInfoTest)).toStrictEqual(siteOutagesExpected)
  })
})